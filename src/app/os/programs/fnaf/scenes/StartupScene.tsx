...
const StartupScene = ({ engine }: StartupSceneProps) => {
    useEffect(() => {
        const timer = setTimeout(() => {
            ...
            engine.audio.playSound('static-long');
        }, 10000);
    ...
    return (
        <div className='text-white text-[clamp(0.5rem,3cqw,4rem)] font-volter w-full h-full flex flex-col justify-center text-center items-center'>
            <h1>WARNING!</h1>
